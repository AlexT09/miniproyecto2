...
## 📖 Jupyter Book (Entregable)

El proyecto incluye un **Jupyter Book** que publica los notebooks como un sitio web navegable y profesional.
...
└── build_jbook.sh  ← Script para construir el libro
```
